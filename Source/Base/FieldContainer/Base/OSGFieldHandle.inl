...
inline
void EditFieldHandle::pushIndexedValueFromCString(const Char8             *str   , UInt32 index)
{
...
inline
void EditFieldHandle::insertIndexedValueFromCString(const Char8             *str   , UInt32 index)
{
    //Do nothing as general case
}
...
template<class FieldT> inline
void   EditSFieldHandle<FieldT>::pushIndexedValueFromCString(const Char8 *str, UInt32 index)
{
    FieldT *pField = static_cast<FieldT *>(_pField);
...
template<class FieldT> inline
void   EditMFieldHandle<FieldT>::pushIndexedValueToStream(OutStream &str, UInt32 index) const
{
...
template<class FieldT> inline
void   EditMFieldHandle<FieldT>::pushIndexedValueFromCString(const Char8 *str, UInt32 index)
{
    FieldT *pField = static_cast<FieldT *>(_pField);
...
template<class FieldT> inline
void EditMFieldHandle<FieldT>::insertIndexedValueFromCString(const Char8             *str   , UInt32 index)
{
    FieldT *pField = static_cast<FieldT *>(_pField);
...
template<class FieldT> inline
void   GetMFieldHandle<FieldT>::pushIndexedValueToStream(OutStream &str, UInt32 index) const
{
    static_cast<const FieldT *>(_pField)->pushIndexedValueToStream(str, index);
}
