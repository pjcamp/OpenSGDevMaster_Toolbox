...
void MField<ValueT, 
            iNamespace, 
            AllocT    >::pushIndexedValueFromCString(const Char8 *str, UInt32 index)
{
    ValueT tmpVal;
...
void MField<ValueT, 
            iNamespace, 
            AllocT    >::pushIndexedValueToStream  (OutStream    &str, UInt32 index) const
{
    typedef typename boost::mpl::if_<boost::mpl::bool_< 
        static_cast<bool>(MFieldTraits    ::Convertible &
...
typename MField<ValueT, 
                ...
                AllocT    >::iterator MField<ValueT, 
                                             iNamespace, 
                                             AllocT    >::insert(
    size_type pos, ArgumentType value)
{
    iterator posItor(begin());
    posItor += pos;
