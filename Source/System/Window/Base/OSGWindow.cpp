...
void Window::updateCursor(Pnt2f MousePos)
{
...
Window::CursorRegionListItor Window::addCursorRegion(const CursorRegion& r)
{
	_CursorRegions.push_back(r);
	return --(_CursorRegions.end());
}

void Window::setCursorType(UInt32 Type)
{
    if(!getLockCursor())
    {
	    _CursorType = Type;
...
bool Window::removeCursorRegion(CursorRegionListItor RegionItor)
{
...
WindowUnrecPtr Window::initWindow(void)
{
    //TODO
...
void Window::setDisplayCallback(DisplayCallbackFunc Callback)
{
   _DisplayCallbackFunc = Callback;
}

void Window::setReshapeCallback(ReshapeCallbackFunc Callback)
{
   _ReshapeCallbackFunc = Callback;
}

EventConnection Window::addUpdateListener(UpdateListenerPtr Listener)
{
   _UpdateListeners.insert(Listener);
   return EventConnection(
       boost::bind(&Window::isUpdateListenerAttached, this, Listener),
       boost::bind(&Window::removeUpdateListener, this, Listener));
}

EventConnection Window::addMouseListener(MouseListenerPtr Listener)
{
   _MouseListeners.insert(Listener);
   return EventConnection(
       boost::bind(&Window::isMouseListenerAttached, this, Listener),
       boost::bind(&Window::removeMouseListener, this, Listener));
}

EventConnection Window::addMouseMotionListener(MouseMotionListenerPtr Listener)
{
   _MouseMotionListeners.insert(Listener);
   return EventConnection(
       boost::bind(&Window::isMouseMotionListenerAttached, this, Listener),
       boost::bind(&Window::removeMouseMotionListener, this, Listener));
}

EventConnection Window::addMouseWheelListener(MouseWheelListenerPtr Listener)
{
   _MouseWheelListeners.insert(Listener);
   return EventConnection(
       boost::bind(&Window::isMouseWheelListenerAttached, this, Listener),
       boost::bind(&Window::removeMouseWheelListener, this, Listener));
}

EventConnection Window::addKeyListener(KeyListenerPtr Listener)
{
   _KeyListeners.insert(Listener);
   return EventConnection(
       boost::bind(&Window::isKeyListenerAttached, this, Listener),
       boost::bind(&Window::removeKeyListener, this, Listener));
}

EventConnection Window::addWindowListener(WindowListenerPtr Listener)
{
   _WindowListeners.insert(Listener);
   return EventConnection(
       boost::bind(&Window::isWindowListenerAttached, this, Listener),
       boost::bind(&Window::removeWindowListener, this, Listener));
}

void Window::removeMouseListener(MouseListenerPtr Listener)
{
...
void Window::removeUpdateListener(UpdateListenerPtr Listener)
{
...
void Window::removeMouseMotionListener(MouseMotionListenerPtr Listener)
{
...
void Window::removeMouseWheelListener(MouseWheelListenerPtr Listener)
{
...
void Window::removeKeyListener(KeyListenerPtr Listener)
{
...
ViewportUnrecPtr Window::windowToViewport(const Pnt2f& WindowPoint, Pnt2f& ViewportPoint)
{
...
void Window::detatchAllListeners(void)
{
...
void Window::produceMouseClicked(const MouseEvent::MouseButton& Button, const Pnt2f& Location)
{
...
void Window::produceMouseEntered(const Pnt2f& Location)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceMouseExited(const Pnt2f& Location)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceMousePressed(const MouseEvent::MouseButton& Button, const Pnt2f& Location)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceMouseReleased(const MouseEvent::MouseButton& Button, const Pnt2f& Location)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceMouseWheelMoved(const Int32& WheelRotation, const Pnt2f& Location, const MouseWheelEvent::ScrollType& TheScrollType)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceMouseMoved(const Pnt2f& Location, const Vec2f& Delta)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceMouseDragged(const MouseEvent::MouseButton& Button, const Pnt2f& Location, const Vec2f& Delta)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceKeyPressed(const KeyEvent::Key& TheKey, const UInt32& Modifiers)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceKeyReleased(const KeyEvent::Key& TheKey, const UInt32& Modifiers)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceKeyTyped(const KeyEvent::Key& TheKey, const UInt32& Modifiers)
{
    //Check if Input is blocked
    if(_BlockInput) { return; }
...
void Window::produceWindowOpened(void)
{
...
void Window::produceWindowClosing(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowClosed(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowIconified(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowDeiconified(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowActivated(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowDeactivated(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowEntered(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceWindowExited(void)
{
   const WindowEventUnrecPtr TheEvent = WindowEvent::create(WindowUnrecPtr(this), getSystemTime());
   for(WindowListenerSetConstItor SetItor(_WindowListeners.begin()) ; SetItor != _WindowListeners.end() ; ++SetItor)
   {
...
void Window::produceUpdate(const Time& ElapsedTime)
{
...
void Window::validateClickCount(const MouseEvent::MouseButton& Button, const Time& TimeStamp, const Pnt2f& Location)
{
...
void Window::updateClickCount(const MouseEvent::MouseButton& Button, const Time& TimeStamp, const Pnt2f& Location)
{
