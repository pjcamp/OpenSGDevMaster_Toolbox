...
inline
void Window::blockInputConnections(bool Block)
{
    _BlockInput = Block;
}

inline
bool Window::isBlockInputConnections(void) const
{
    return _BlockInput;
}
    
inline
bool Window::isMouseListenerAttached(MouseListenerPtr Listener) const
{
    return _MouseListeners.find(Listener) != _MouseListeners.end();
}

inline
bool Window::isMouseMotionListenerAttached(MouseMotionListenerPtr Listener) const
{
    return _MouseMotionListeners.find(Listener) != _MouseMotionListeners.end();
}

inline
bool Window::isMouseWheelListenerAttached(MouseWheelListenerPtr Listener) const
{
    return _MouseWheelListeners.find(Listener) != _MouseWheelListeners.end();
}

inline
bool Window::isKeyListenerAttached(KeyListenerPtr Listener) const
{
    return _KeyListeners.find(Listener) != _KeyListeners.end();
}

inline
bool Window::isWindowListenerAttached(WindowListenerPtr Listener) const
{
    return _WindowListeners.find(Listener) != _WindowListeners.end();
}

inline
bool Window::isUpdateListenerAttached(UpdateListenerPtr Listener) const
{
    return _UpdateListeners.find(Listener) != _UpdateListeners.end();
}

inline
Window::FileDialogFilter::FileDialogFilter(const std::string& Name, const std::string& Filter) : 
_Name(Name),
_Filter(Filter)
{
}
...
inline
const std::string& Window::FileDialogFilter::getName(void) const
{
    return _Name;
}

inline
const std::string& Window::FileDialogFilter::getFilter(void) const
{
    return _Filter;
}

inline
RenderAction * Window::getRenderAction(void)
{
	return _RenderAction;
}

inline
void Window::setRenderAction(RenderAction *action)
{
	_RenderAction = action;
}

inline
void Window::internalDraw(void)
{
...
inline
void Window::internalReshape(Vec2f size)
{
...
inline
UInt32 Window::getCursorType(void) const
{
	return _CursorType;
}

inline
Window::Click::Click(Time TimeStamp, Pnt2f Location) :
