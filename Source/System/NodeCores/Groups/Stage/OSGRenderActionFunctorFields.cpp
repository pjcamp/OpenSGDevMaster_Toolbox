...
DataType FieldTraits<RenderActionFunctorCallback     >::_type(
    "RenderActionFunctorCallback",
    "");

OSG_FIELDTRAITS_GETTYPE   (RenderActionFunctorCallback     )

#endif

OSG_FIELD_DLLEXPORT_DEF1(SField, RenderActionFunctorCallback);
OSG_FIELD_DLLEXPORT_DEF1(MField, RenderActionFunctorCallback);

#if 0
template <>
OSG_DLL_EXPORT
void FieldDescription<FieldTraits<RenderActionFunctorCallback>,
...
{
    FWARNING(("FieldDescription::cloneValues called for sf renderact functors.\n"));
}
