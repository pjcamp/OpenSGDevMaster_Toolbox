...
class OSG_WINDOWCARBON_DLLMAPPING CarbonWindow : public CarbonWindowBase
{
  ...
  public:
	...
	virtual std::vector<Path, std::allocator<Path> > openFileDialog(const std::string&, const std::vector<WindowEventProducer::FileDialogFilter, std::allocator<WindowEventProducer::FileDialogFilter> >&, const Path&, bool);
	virtual Path saveFileDialog(const std::string&, const std::vector<WindowEventProducer::FileDialogFilter, std::allocator<WindowEventProducer::FileDialogFilter> >&, const std::string&, const Path&, bool);
